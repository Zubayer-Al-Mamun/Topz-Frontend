  ...
  return (
    <div className="flex items-center justify-center">
      <form className="w-full rounded-md">
        ...
        <label className=" text-[18px] pl-1 font-semibold" htmlFor="name">Name (আপনার নাম লিখুন)</label>
        <input
          onChange={(event)=> setOrder({...order, customerDetails : {...order.customerDetails, name : event.target.value}})}
          type="text"
        ...
        <label className=" text-[18px] pl-1 font-semibold" htmlFor="phone">Phone (সচল মোবাইল নাম্বার দিন)</label>
        <input
          onChange={(event)=> setOrder({...order, customerDetails : {...order.customerDetails, phone : event.target.value}})}
          type="tel"
        ...
        <label className="mt-2 text-[18px] pl-1 font-semibold" htmlFor="address">Address (আপনার পূর্ণাঙ্গ ঠিকানা লিখুন)</label>
        <textarea
          placeholder="গ্রাম/সড়ক নং,  ইউনিয়ন,  থানা/উপজেলা,  জেলা"
          onChange={(event)=> setOrder({...order, customerDetails : {...order.customerDetails, addressFull : event.target.value}})}
        ...
        <label className="mt-2 text-[18px] pl-1 font-semibold" htmlFor="note">Note (বিশেষ কিছু বলে দিতে পারেন)</label>
        <textarea
